...
Microsoft Entra Connect was installed on the domain controller and configured to synchronize identities between the on-premises Active Directory environment (corp.local) and Microsoft Entra ID.
